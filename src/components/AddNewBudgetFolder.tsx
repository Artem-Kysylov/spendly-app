...
const NewBudget = ({ onClick }: { onClick: () => void }) => {
  return (
    <div onClick={onClick} className='flex flex-col items-center justify-center gap-[8px] border border-primary rounded-lg cursor-pointer w-[100%] md:w-[335px] md:min-w-[335px] h-[200px] transition-colors duration-300 hover:bg-primary group'>
